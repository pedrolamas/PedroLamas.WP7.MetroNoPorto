...
namespace PedroLamas.WP7.MetroNoPorto.Helpers
{
    /// <summary>
    ...
    public sealed partial class Viewbox : ContentControl
    {
        ...
        private Size ComputeScaleFactor(Size availableSize, Size contentSize)
        {
            ...
            if ((stretch != Stretch.None) && (isConstrainedWidth || isConstrainedHeight))
            {
                ...
                scaleX = contentSize.Width <= 0.00001 ? 0.0 : (availableSize.Width / contentSize.Width);
                scaleY = contentSize.Height <= 0.00001 ? 0.0 : (availableSize.Height / contentSize.Height);
